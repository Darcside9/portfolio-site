...
const Hero = () => {
  ...
  const fullText = "U[I/X] Designer & Web Developer";
  ...
  const socialLinks = [
    ...
    {
      icon: FaDiscord,
      href: "https://discordapp.com/users/881256110860927019",
    ...
    {
      icon: FaWhatsapp,
      href: "https://wa.me/2349029550243",
    ...
    >
      ...
      <div className="relative z-10 text-center p-8 rounded-lg">
        ...
        <motion.p
          ...
          animate={{ y: 0 }}
          transition={{ duration: 0.5 }}
          className="text-x1 md:text-2xl mb-8"
          aria-live="polite"
        >
          {text}
        </motion.p>
        ...
        className="flex justify-center">
          ...
          className="w-full max-w-[250px] mt-4 h-[55]"
          >
            <Link
              href="/resume"
              className="inline-block bg-gray-700 hover:bg-gray-300/30 text-white py-[15px] w-full h-full font-bold rounded-xl transition-all duration-200 cursor-pointer"
            >
              Get Resume
            </Link>
          </motion.div>
